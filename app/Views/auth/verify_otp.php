...
<form action="<?= base_url('auth/processOtp'); ?>" method="POST" class="w-full space-y-5">
	...
	<button type="submit"
		class="left-content-gsap w-full py-3 sm:py-3.5 bg-brand-primary hover:bg-brand-primary_hover text-white text-xs sm:text-sm font-bold flex items-center justify-center gap-2.5 rounded-md transition-all shadow-lg shadow-brand-primary/25 active:scale-[0.98] cursor-pointer">
